    ...
    <div class="flex gap-5 items-center mr-5">
        ...
        <div class="relative w-max">
            <span class="absolute w-4 h-4 text-white top-2 left-2">
                <svg class="w-4 h-4" width="24" height="24" viewBox="0 0 24 24" role="presentation">
            ...
            <input class="h-8 w-full outline-none rounded-sm text-sm text-black bg-search-grey pr-3.5 pl-7 border-gray-400 border-solid border-2" placeholder="Search">
        </div>
